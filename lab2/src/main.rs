...
fn spawn_platforms(mut commands: Commands, asset_server: Res<AssetServer>) {
    // Spawn a platform as an example. You can add more.
    commands
        .spawn(SpriteBundle {
            transform: Transform::from_xyz(650.0, 100.0, 0.0), // Adjust position as needed.
